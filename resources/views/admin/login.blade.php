...
<head>
    ...
    <![endif]-->
    <style>
        body {background-image:url("/layui/images/bg.jpg");height:100%;width:100%;}
    ...
    <div class="admin-login-background">
        ...
        <form class="layui-form" action="">
            ...
            <div>
                ...
                <input type="password" name="password" placeholder="请输入密码" autocomplete="off" class="layui-input admin-input" value="12345678">
            </div>
            <div>
